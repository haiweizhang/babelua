...
namespace Microsoft.VisualStudioTools {
    ...
    class ProvideDebugEngineAttribute : RegistrationAttribute {
        ...
        public override void Register(RegistrationContext context) {
            ...
            engineKey.SetValue("PortSupplier", "{3FCFDB79-2F1D-4D01-A301-C13E614A40E4}"); // {708C1ECA-FF48-11D2-904F-00C04FA302A1}
            ...
            //engineKey.SetValue("FunctionBP", 1); // TODO: Implement LuaLanguageInfo.ResolveName
            ...
            using (var incompatKey = engineKey.CreateSubkey("IncompatibleList")) {
                ...
                // In VS 2012, only native/Lua mixing is supported - other stock engines are not updated yet, and
            ...
            using (var autoSelectIncompatKey = engineKey.CreateSubkey("AutoSelectIncompatibleList")) {
                autoSelectIncompatKey.SetValue("guidNativeOnlyEng", "{B73B01D3-A022-437F-9C87-C9716D1A24B6}");//3B476D35-A401-11D2-AAD4-00C04F990171
            }
