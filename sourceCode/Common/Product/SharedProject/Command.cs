...
namespace Microsoft.VisualStudioTools {
    ...
    /// the command in CommandTable.  LuaToolsPackage will then register the command on startup.
    /// </summary>
    internal abstract class Command {
        ...
        /// <summary>
        /// Enables a command to hook into our edit filter for Lua text buffers.
        /// 
