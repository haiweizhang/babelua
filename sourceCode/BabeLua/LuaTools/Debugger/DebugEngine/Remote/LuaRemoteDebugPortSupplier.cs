...
namespace Microsoft.LuaTools.Debugger.Remote {
    public abstract class LuaRemoteDebugPortSupplier : IDebugPortSupplier2, IDebugPortSupplierDescription2 {
        ...
        protected LuaRemoteDebugPortSupplier(Guid guid, ushort defaultPort, bool useSsl) {
            _guid = guid;
        ...
        public int GetPortSupplierName(out string pbstrName) {
            pbstrName = "Lua remote debugging " + (_useSsl ? "(SSL)" : "(unsecured)");
            return 0;
        }
        ...
        public int GetDescription(enum_PORT_SUPPLIER_DESCRIPTION_FLAGS[] pdwFlags, out string pbstrText) {
            pbstrText =
                "Allows debugging a Lua process on a remote machine running any OS, if it can be connected to via TCP, " +
    ...
    public class LuaRemoteDebugPortSupplierUnsecured : LuaRemoteDebugPortSupplier {
        ...
        public LuaRemoteDebugPortSupplierUnsecured()
    ...
    public class LuaRemoteDebugPortSupplierSsl : LuaRemoteDebugPortSupplier {
        public const string PortSupplierId = "{9110921B-1371-4C33-8844-C5601F503390}";
        public static readonly Guid PortSupplierGuid = new Guid(PortSupplierId);
        public const ushort DefaultPort = 5678;

        public LuaRemoteDebugPortSupplierSsl()
