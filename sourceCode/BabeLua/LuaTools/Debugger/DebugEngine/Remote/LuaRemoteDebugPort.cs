...
namespace Microsoft.LuaTools.Debugger.Remote {
    internal class LuaRemoteDebugPort : IDebugPort2 {
        private readonly LuaRemoteDebugPortSupplier _supplier;
        ...
        public LuaRemoteDebugPort(LuaRemoteDebugPortSupplier supplier, string hostName, ushort portNumber, string secret, bool useSsl) {
