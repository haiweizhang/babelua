...
namespace Microsoft.LuaTools.Debugger.Remote {
    internal class LuaRemoteDebugProcess : IDebugProcess2, IDebugProcessSecurity2 {
        ...
        public LuaRemoteDebugPort DebugPort {
            get { return _port; }
        }
        ...
        public int EnumPrograms(out IEnumDebugPrograms2 ppEnum) {
            ppEnum = new LuaRemoteEnumDebugPrograms(this);
            return 0;
        }
