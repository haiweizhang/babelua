...
namespace Microsoft.LuaTools.Project
{
    ...
    /// </remarks>
    [Guid(LuaConstants.EditorFactoryGuid)]
    public class LuaEditorFactory : CommonEditorFactory {
        ...
        protected override void InitializeLanguageService(IVsTextLines textLines) {
            ...
            if (userData != null) {
                Guid langSid = typeof(LuaLanguageInfo).GUID;
    ...
    [Guid(LuaConstants.EditorFactoryPromptForEncodingGuid)]
    public class LuaEditorFactoryPromptForEncoding : LuaEditorFactory {
