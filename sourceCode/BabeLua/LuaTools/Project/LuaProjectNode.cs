...
namespace Microsoft.LuaTools.Project {
    [Guid(LuaConstants.ProjectNodeGuid)]
    internal class LuaProjectNode : CommonProjectNode, ILuaProject {
...
*/
        public LuaProjectNode(CommonProjectPackage package)
//            : base(package, Utilities.GetImageList(typeof(LuaProjectNode).Assembly.GetManifestResourceStream(LuaConstants.ProjectImageList))) {
            : base(package, Utilities.GetImageList(typeof(LuaProjectNode).Assembly.GetManifestResourceStream("Microsoft.LuaTools.Resources.Solution.png")))//Images.png
        {
/*
...
*/
        ...
        public override Type GetProjectFactoryType() {
            return typeof(LuaProjectFactory);
        }
        ...
        public override Type GetGeneralPropertyPageType() {
            return typeof(LuaGeneralPropertyPage);
        }
...
*/
        ...
        public override IProjectLauncher GetLauncher() {
            return BabePackage.GetLauncher(this);
        }
/*
