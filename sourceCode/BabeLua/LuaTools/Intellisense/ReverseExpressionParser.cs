...
namespace Microsoft.LuaTools.Intellisense {
    /// <summary>
    ...
    class ReverseExpressionParser : IEnumerable<ClassificationSpan> {
        ...
        private LuaClassifier _classifier;
        ...
        internal static IEnumerator<ClassificationSpan> ReverseClassificationSpanEnumerator(LuaClassifier classifier, SnapshotPoint startPoint) {
...
/*
            ...
            while (MoveNextSkipExplicitNewLines(enumerator)) {
                if (enumerator.Current.ClassificationType == _classifier.Provider.Keyword) {
                    ...
                    if (LuaKeywords.IsOnlyStatementKeyword(enumerator.Current.Span.GetText())) {
                        return false;
                    }
                }
...
/*
                        ...
                        if (nesting == 0 && otherNesting == 0) {
                            ...
                            LuaKeywords.IsOnlyStatementKeyword(text)) ||
...
/*
            if (cur != null && cur.ClassificationType.IsOfType(LuaPredefinedClassificationTypeNames.Operator)) {
...
*/
        ...
        public LuaClassifier Classifier {
            get { return _classifier ?? (_classifier = (LuaClassifier)_buffer.Properties.GetProperty(typeof(LuaClassifier))); }
        }
...
/*
                    ...
                    LuaKeywords.IsOnlyStatementKeyword(token.Span.GetText())) {
                    return false;
*/
                }
            }
