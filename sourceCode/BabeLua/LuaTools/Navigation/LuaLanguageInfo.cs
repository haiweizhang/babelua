...
namespace Microsoft.LuaTools.Navigation {
    ...
    /// </summary>
    [Guid("EEF0BF43-9475-44D3-B21D-847F1310851E")]//[Guid("bf96a6ce-574f-3259-98be-503a3ad636dd")]
    internal sealed class LuaLanguageInfo : IVsLanguageInfo, IVsLanguageDebugInfo {
        private readonly IServiceProvider _serviceProvider;
        private readonly IComponentModel _componentModel;

        public LuaLanguageInfo(IServiceProvider serviceProvider) {
		...
		public int GetFileExtensions(out string pbstrExtensions)
		{
			...
			pbstrExtensions = LuaConstants.FileExtension + ";" + LuaConstants.WindowsFileExtension;
			return VSConstants.S_OK;
		}
		...
		public int GetLanguageName(out string bstrName)
		{
			...
			bstrName = LuaConstants.LanguageName;
			return VSConstants.S_OK;
		}
        ...
        public int GetLanguageID(IVsTextBuffer pBuffer, int iLine, int iCol, out Guid pguidLanguageID) {
            pguidLanguageID = DebuggerConstants.guidLanguageLua;
            return VSConstants.S_OK;
        }
...
/*
            ...
            ILuaProjectEntry projEntry;
            if (buffer.TryGetLuaAnalysis(out projEntry)) {
...
/*
        private static string FindNodeInTree(LuaAst tree, SuiteStatement statement, int line) {
            if (statement != null) {
