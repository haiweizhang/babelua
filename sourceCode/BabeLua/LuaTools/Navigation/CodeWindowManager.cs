...
//        private DropDownBarClient _client;
        ...
        static CodeWindowManager() {
            BabePackage.Current.OnIdle += OnIdle;
        }
...
/*
            if (LuaToolsPackage.Instance.LangPrefs.NavigationBar) {
...
/*
            var luaProjectEntry = _textBuffer.GetAnalysis() as ILuaProjectEntry;
            if (luaProjectEntry == null) {
            ...
            _client = new DropDownBarClient(wpfTextView, luaProjectEntry);
