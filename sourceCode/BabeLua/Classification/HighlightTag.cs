...
namespace Babe.Lua.Classification
{
    class HighlightTag
    {
        ...
        public static Color LuaFrameworkColor;
        ...
        static ClassificationTag CTag;
        static ClassificationTag LuaFrameworkTag;
        ...
        static HashSet<string> LuaFramework;
        ...
        {
            var kw = BabePackage.Setting.KeyWords;
            CColor = kw.C.Key;
            C = kw.C.Value;
            LuaFrameworkColor = kw.Framework.Key;
            LuaFramework = kw.Framework.Value;
        ...
        public static ClassificationTag GetTag(Irony.Parsing.Token token)
        {
			...
			{
				if (C != null && C.Contains(token.Text)) tag = CTag;
				else if (LuaFramework != null && LuaFramework.Contains(token.Text)) tag = LuaFrameworkTag;
